...
diligently, at scale, and in a way that mostly does not let a reader check any particular
claim. \pctHeldOut{} of papers test a result outside the loop that produced it,
\pctAuditNone{} provide no auditability mechanism at all, and \pctHumanUnspec{} do not say
what humans did. The papers claiming the AI produced new scientific knowledge are among the
least checkable in the corpus.
